...
proc tclAE::aete::build::buildSuite {name description ID level version {events {}} {classes {}} {comparisons {}} {enumerations {}}} {
    ...
    # suite ID
    append suite [binary format a4 [encoding convertto $ID]]
...
proc tclAE::aete::build::buildEvent {name description class ID reply direct {parameters {}}} {
    ...
    # event class & ID
    append event [binary format a4a4 [encoding convertto $class] [encoding convertto $ID]]
...
proc tclAE::aete::build::buildParameter {name keyword type description flags} {
    ...
    append param [binary format a4 [encoding convertto $keyword]]
    
    append param [binary format a4 [encoding convertto $type]]
...
proc tclAE::aete::build::buildEnumeration {ID enumerators} {
    set enumeration [binary format a4 [encoding convertto $ID]]
...
proc tclAE::aete::build::buildEnumerator {name ID description} {
    ...
    append enumerator [binary format a4 [encoding convertto $ID]]
...
proc tclAE::aete::build::buildDirectParameter {type description flags} {
    set param [binary format a4 [encoding convertto $type]]
    
    set descLen [string length $description]
    
    # parameter description (Pascal string)
    append param [binary format ca* $descLen [encoding convertto $description]]
...
proc tclAE::aete::build::buildString {str} {
    ...
    # Pascal string
    set String [binary format ca* $strLen [encoding convertto $str]]
...
proc tclAE::aete::build::buildIdentification {name description} {
    ...
    set identification [binary format ca* $nameLen [encoding convertto $name]]
    
    # event description (Pascal string)
    append identification [binary format ca* $descLen [encoding convertto $description]]
